...
<section class="container">
	...
	<div class="login-body">
			<div class="login-header">
				<img src="{{ asset('user/img/medecin.png') }}" alt="">	
				<p>
					<span class="text-bold text-primary"> Connexion Des Medecins </span>
				</p>
			</div>
			<div class="form-group">
				<form action="{{ route('medecin.login') }}" method="post" class="box">
					@csrf
