...
<div class="page-header">
    ...
    <nav aria-label="breadcrumb">
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Ajouter un antécedent</li>
        </ul>
    </nav>
</div>
    ...
    <div class="card-body">
        <div class="d-flex justify-content-between">
            <div>
                ...
                <h5>Ajouter un antécedent pour cette patiente</h5>
            </div>
            <div>
...
<div class="card card-outline-primary">
    <div class="card-body">
        @include('medecin.partials.antecedentForm',[
            'action' => route('medecin.patients.antecedent.store', $patient),
            'method' => 'POST',
            'formType' => 'create',
            'patient' => $patient,
        ])
