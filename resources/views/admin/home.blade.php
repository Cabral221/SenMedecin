            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                <td><img src="{{ asset('backend/assets/images/faces/face1.jpg') }}" class="mr-2" alt="image"> David Grey </td>
                            ...
                            <tr>
                                <td><img src="{{ asset('backend/assets/images/faces/face2.jpg') }}" class="mr-2" alt="image"> Stella Johnson </td>
                            ...
                            <tr>
                                <td><img src="{{ asset('backend/assets/images/faces/face3.jpg') }}" class="mr-2" alt="image"> Marina Michel </td>
                            ...
                            <tr>
                                <td><img src="{{ asset('backend/assets/images/faces/face4.jpg') }}" class="mr-2" alt="image"> John Doe </td>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex mt-5 align-items-top">
                    <img src="{{ asset('backend/assets/images/faces/face3.jpg') }}" class="img-sm rounded-circle mr-3" alt="image">
