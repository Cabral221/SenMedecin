...
<footer class="footer">
	<div class="container bottom_border">
		<div class="footer_left">
			<h6 class="headin5_amrc col_white_amrc pt2">Find us</h6>
			<!--headin5_amrc-->
		...
		<div class="footer_right"> 
			<h6 class="headin5_amrc col_white_amrc pt2">Follow us</h6>
		<!--headin5_amrc ends here-->

			<ul class="footer_ul2_amrc">
				<li><a href="#"><i class="fab fa-twitter fleft padding-right"></i> </a><p>Lorem Ipsum .... <a href="#">https://www.lipsum.com/</a></p></li>
				<li><a href="#"><i class="fab fa-twitter fleft padding-right"></i> </a><p>Lorem Ipsum .... <a href="#">https://www.lipsum.com/</a></p></li>
				<li><a href="#"><i class="fab fa-twitter fleft padding-right"></i> </a><p>Lorem Ipsum .... <a href="#">https://www.lipsum.com/</a></p></li>
			</ul>
		</div>
